...
In previous lessons, we saw how to use the library pandas to load the city
...
`yearly_files/surveys2002.csv` which contains the path to the new filename
